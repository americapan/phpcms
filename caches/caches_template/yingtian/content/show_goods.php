        ...
        $(".example1").luara({width: "315", height: "250", interval: 5000, selected: "seleted", deriction: "top"});
            ...
            <div id="divSocialBookmarks" class="ProductDetailsSocialBookmarks">
                ...
                <div class="addthis_toolbox addthis_default_style addthis_32x32_style">
                    <a href="#" title="Facebook" class="addthis_button_facebook addthis_button_preferred_1 at300b"><span class=" at300bs at15nc at15t_facebook"><span class="at_a11y">Share on facebook</span></span></a>
                    <a href="#" title="Tweet" class="addthis_button_twitter addthis_button_preferred_2 at300b"><span class=" at300bs at15nc at15t_twitter"><span class="at_a11y">Share on twitter</span></span></a>
                    <a href="#" title="电子信箱" target="_blank" class="addthis_button_email addthis_button_preferred_3 at300b"><span class=" at300bs at15nc at15t_email"><span class="at_a11y">Share on email</span></span></a> 
                    <a href="#" title="打印" class="addthis_button_print addthis_button_preferred_4 at300b"><span class=" at300bs at15nc at15t_print"><span class="at_a11y">Share on print</span></span></a>
                    ...
                    <a href="#" style="display: inline-block;" class="addthis_counter addthis_bubble_style">
                        <a href="#" title="更多服务" target="_blank" class="addthis_button_expanded">0</a>
                        <a class="atc_s addthis_button_compact"><span></span></a>
                    </a>
                    <div class="atclear"></div></div>
                <script type="text/javascript" src="<?php echo JS_PATH;?>yingtian/addthis_widget.js"></script>
                <!-- AddThis Button END -->
            </div>
            <div style="clear:both"></div>
            <div style="clear:both"></div>
