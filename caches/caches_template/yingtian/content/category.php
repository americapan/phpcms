    ...
    <aside class="LayoutLeftColumn">
        <div class="LayoutLeftColumnInner">
            <div id="ctl27_dvControl" class="Control CategoryNavigationLinks Control_359">
                <div id="ctl27_dvControlHeader" class="ControlHeader ControlHeader_359">Technical documents</div>
                ...
                <div class="ControlHeader ControlHeader_359" style="margin-top:20px;">Recommended1111111111</div>
