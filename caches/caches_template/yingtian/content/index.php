    ...
    <div class="Control Slideshow Control_178">
        <div style="width: 918px; height: 268px; overflow: hidden;" class="Slider Slider_178">
            ...
            <ul style="width: 4590px; margin-left: -1836px;" class="SlideList SlideList_178">         	
                ...
                <li style="width: 918px; height: 268px; float: left;" class="ControlItem Slide ControlItem_178"><a href="<?php echo $r['url'];?>" class="ControlLink ControlLink_178" target="_blank"><img src="<?php echo $r['thumb'];?>" alt="<?php echo str_cut($r['title'],30);?>" title="" border="0" height="268" width="918"></a></li>
                <?php $n++;}unset($n); ?>
            </ul>
            ...
            <div class="Control Control_2459"><br>
                <table class="centerTable"><tbody><tr><td style="background-color: rgb(242, 242, 242);"> 
                            ...
                            <td style="width: 410px;">
                                <a href="http://localhost/phpcms/html/about/contactus/"><img src="<?php echo IMG_PATH;?>yingtian/service.jpg" width="410px;"></a><br>
