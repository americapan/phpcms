...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo CSS_PATH;?>yingtian/style.css" rel="stylesheet" type="text/css"></link>
        <link href="<?php echo CSS_PATH;?>yingtian/search.css" rel="stylesheet" type="text/css"></link>
        <script type="text/javascript" src="<?php echo JS_PATH;?>yingtian/jquery.js"></script>
        <script type="text/javascript" src="<?php echo JS_PATH;?>yingtian/cookie.js"></script>
        <script type="text/javascript" src="<?php echo JS_PATH;?>yingtian/search_common.js"></script>
        <!--[if lt IE 9]>
                    ...
                    <div class="LayoutTopMiddle">
                        <div class="LayoutTopLeft">
                            <div class="Control Control_306">
                                <a href="<?php echo siteurl($siteid);?>" title="<?php echo $SEO['name'];?>"><img src="<?php echo IMG_PATH;?>yingtian/logo.png"  alt="<?php echo $SEO['name'];?>" style="margin-top:12px; margin-left:15px;"></a>
                                <a class="mobilecall" href="tel:+86-392-3311689">
                                    <img src="<?php echo IMG_PATH;?>yingtian/blank.png" style="margin-left:315px;margin-top:-65px;float:left;">
                                </a>
                            </div>
                    ...
                    <div class="LayoutTopBottom">
                        ...
                        <div class="inner">
                            ...
                            <div class="HorizontalNav Control Control_312">
                                <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=729153939f3cb0fec59a0763fc793d61&action=category&catid=28&num=25&siteid=%24siteid&order=listorder+ASC&return=cateinfo\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {$cateinfo = $content_tag->category(array('catid'=>'28','siteid'=>$siteid,'order'=>'listorder ASC','limit'=>'25',));}?>
                                <?php $n=1;if(is_array($cateinfo)) foreach($cateinfo AS $r) { ?>
                            ...
                            <div id="ctl43_spHorizontalNav" class="HorizontalNav Control Control_313">
                                <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=e4d0a1e24c7feeb69d694e91b93e88bc&action=category&catid=1&num=15&siteid=%24siteid&order=listorder+ASC&return=menu\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {$menu = $content_tag->category(array('catid'=>'1','siteid'=>$siteid,'order'=>'listorder ASC','limit'=>'15',));}?>
